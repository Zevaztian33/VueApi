        ...
        <div class="d-flex">
          <div class="card text-center m-5 bg-dark border-light" style="width: 18rem;">
            ...
            <div class="card-body ">
              ...
              <button type="button" class="btn btn-success ml-4" data-toggle="modal" :data-target="'#opinion'+amiibo.head+amiibo.tail">Opinión
                <font-awesome-icon icon="edit"></font-awesome-icon>
              </button>
              <button type="button" class="btn btn-primary ml-4" data-toggle="modal" :data-target="'#verMas'+amiibo.head+amiibo.tail">Ver
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input type="text" placeholder="Ingresa tu nombre" v-model="amiibo.opinion_nombre">
                <p class="text-success">Tu opinión:</p>
                <textarea name="comentarios" rows="10" cols="45" placeholder="Ingresa tu opinión aquí" v-model="amiibo.opinion_comentario"></textarea>
              </div>
              <hr>
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" @click="guardarOpinion(amiibo)">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" data-dismiss="modal" @click="addFavs(amiibo)" :disabled="amiibo.favorito">
  ...
  export default {
    ...
    methods: {
      ...
      guardarOpinion(amiibo){
        ...
        if (amiibo.opinion_nombre !== null && amiibo.opinion_comentario !== null){
          let opinion = {
            id: idCacho,
            nombre: amiibo.opinion_nombre,
            comentario: amiibo.opinion_comentario,
            name: amiibo.name
          }
